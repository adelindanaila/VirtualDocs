      ...
      <div class="flex justify-between items-center py-6 md:justify-start md:space-x-10">
        ...
        <nav class="hidden md:flex space-x-10">
          ...
          <router-link
            ...
            class="text-base font-medium text-gray-500 hover:text-gray-900"
            :class="
              this.$router.currentRoute.value.fullPath.includes('/admin')
        ...
        >
          <button
            class="p-1 rounded-full text-gray-700 hover:text-indigo focus:outline-none focus:ring-2 ring-indigo-400 focus:text-indigo-400 transition"
          >
...
export default {
  ...
  methods: {
    ...
    modal_open(component) {
      if (component === 'signin') this.signin_modal = true
      else if (component === 'signup') this.signup_modal = true
    ...
    modal_close(component) {
      ...
      if (component === 'signin') element_id = 'signin_modal'
      else if (component === 'signup') element_id = 'signup_modal'
      ...
      setTimeout(() => {
        if (component === 'signin') this.signin_modal = false
        else if (component === 'signup') this.signup_modal = false
