      ...
      <div>
        ...
        >
          ...
          <a
            ...
            v-show="
              Math.abs(page - this.data.page) < 3 || page === this.data.totalPages - 1 || page === 0
            "
            :key="`page-${page}`"
            @click="this.$parent.pagination(page)"
            :class="
              this.data.page === page ? 'bg-indigo-100 text-indigo-400 pointer-events-none' : null
            "
